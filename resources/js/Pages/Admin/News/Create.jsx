            ...
            <div className="max-w-4xl mx-auto">
                <form onSubmit={submit} className="bg-white rounded-[2.5rem] shadow-xl border border-gray-100 overflow-hidden">
                    <div className="p-10 space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ví dụ: Lễ khánh thành điểm trường mầm non Bản Cao..."
                                    />
                         ...
                         <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div>
                                    <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Nội dung bài viết (Dùng AI để gen HTML)</label>
                                    <textarea
                                        ...
                                        placeholder="Nhập nội dung chi tiết bài viết hoặc sử dụng nút Sáng tạo bằng AI mang phong cách trang trọng ở trên..."
                                    />
                                ...
                                <div>
                                    <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Trạng thái xuất bản</label>
                                    <select
                    ...
                    <div className="p-8 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                        <p className="text-xs text-gray-400 font-bold uppercase italic">* Bài viết sẽ được hiển thị ngay sau khi xuất bản</p>
                        <div className="flex gap-4">
                            ...
                            >
                                {processing ? "Đang xử lý..." : "Đăng bài ngay"}
                            </button>
                        </div>
                    </div>
                </form>
